...
custom_version() {
    ...
    download_link="https://raw.githubusercontent.com/Ebi7380/ebimehr/master/install.sh"
...
update_shell() {
    wget -O /usr/bin/x-ui -N --no-check-certificate https://github.com/Ebi7380/ebimehr/raw/main/x-ui.sh
    if [[ $? != 0 ]]; then
        echo ""
